...
%description
Test kernel module package with GPL license but missing supported flag.
Used for validating soliddriver-checks supported flag detection.
...
- Initial test package for supported flag validation
